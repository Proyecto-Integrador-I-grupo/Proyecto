    ...
    <section id="matricula-view" className="view hidden">
      ...
      <Modal id="modalMatricula" title={<><i className="bi bi-journal-check"></i> Procesar Matrícula</>} lg className="edu-work-modal">
        <form id="matricula-form"><div className="modal-body p-4"><div className="row g-3">
          ...
          <div className="col-12"><div id="mat-estado-financiero" className="mat-financial-status neutral"><div className="d-flex align-items-center justify-content-between gap-2 flex-wrap"><div className="d-flex align-items-center gap-2"><i className="bi bi-wallet2"></i><strong>Validación financiera</strong></div><button type="button" id="mat-ir-financiero" className="btn btn-sm btn-outline-primary"><i className="bi bi-cash-coin me-1"></i>Ir a financiero</button></div><div id="mat-estado-financiero-texto" className="small mt-1">Selecciona un estudiante para verificar el abono mínimo de matrícula.</div><div id="mat-deudas-pendientes" className="small mt-2"></div></div></div>
