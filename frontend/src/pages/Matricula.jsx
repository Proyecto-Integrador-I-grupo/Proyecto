  ...
  return (
    <section id="matricula-view" className="view hidden">
      ...
      <Modal id="modalGrupo" title={<><i className="bi bi-people"></i> Crear Grupo</>} lg className="edu-work-modal">
        <form id="grupo-form"><div className="modal-body p-4"><div className="row g-3"><div className="col-md-8"><label className="form-label">Nombre del grupo</label><input id="grupo-nombre" className="form-control" maxLength="80" placeholder="Ej.: Grupo Amanecer" required /></div><div className="col-md-4"><label className="form-label">Capacidad</label><input id="grupo-capacidad" type="number" min="1" className="form-control" required /></div><div className="col-md-4"><label className="form-label">Aula</label><input id="grupo-aula" className="form-control" maxLength="40" /></div><div className="col-md-4"><label className="form-label">Hora de inicio</label><input id="grupo-hora-inicio" type="time" className="form-control" /></div><div className="col-md-4"><label className="form-label">Hora de finalización</label><input id="grupo-hora-fin" type="time" className="form-control" /></div><div className="col-12">
<label className="form-label d-flex align-items-center justify-content-between gap-2"><span>Profesor asignado <span className="text-muted fw-normal">(opcional)</span></span><span id="grupo-profesor-count" className="badge text-bg-light border">Ninguno seleccionado</span></label>
<div className="profesor-picker">
<div className="input-group input-group-sm mb-2"><span className="input-group-text"><i className="bi bi-search"></i></span><input id="grupo-profesor-search" className="form-control" maxLength="120" placeholder="Buscar por nombre o materia..." autoComplete="off" /></div>
<select id="grupo-profesor" className="form-select profesor-select" aria-label="Seleccionar profesor"></select>
<div className="d-flex justify-content-between align-items-center gap-2 mt-2"><small className="text-muted">Selecciona el profesor que quedará asignado al grupo.</small><button type="button" id="grupo-profesor-clear" className="btn btn-sm btn-link text-decoration-none px-0">Limpiar</button></div>
</div></div><div className="col-12"><label className="form-label">Buscar sección</label><input id="grupo-seccion-search" className="form-control form-control-sm mb-2" placeholder="Nombre, nivel o año..." /><select id="grupo-seccion" className="form-select" required><option value="" disabled>Seleccionar sección</option></select><div className="form-text">Las secciones asignadas a un grupo activo aparecen bloqueadas.</div><div id="grupo-seccion-empty-hint" className="form-text hidden">No hay secciones registradas.</div></div></div></div><div className="modal-footer"><button type="button" className="btn btn-outline-secondary" data-bs-dismiss="modal">Cerrar</button><button type="submit" className="btn btn-primary">Crear Grupo</button></div></form>
      </Modal>

      <Modal id="modalGestionGrupo" title={<><i className="bi bi-pencil-square"></i> Gestionar Grupo</>} lg>
        <form id="gestion-grupo-form"><div className="modal-body p-4"><div className="row g-3"><div className="col-12"><label className="form-label">Grupo</label><select id="gestion-grupo-select" className="form-select" required><option value="" disabled>Seleccionar grupo</option></select></div><div className="col-md-6"><label className="form-label">Capacidad</label><input id="gestion-grupo-capacidad" type="number" min="1" className="form-control" required /></div><div className="col-md-6"><label className="form-label">Aula</label><input id="gestion-grupo-aula" className="form-control" maxLength="40" /></div><div className="col-md-6"><label className="form-label">Hora de inicio</label><input id="gestion-grupo-hora-inicio" type="time" className="form-control" /></div><div className="col-md-6"><label className="form-label">Hora de finalización</label><input id="gestion-grupo-hora-fin" type="time" className="form-control" /></div><div className="col-12">
<label className="form-label d-flex align-items-center justify-content-between gap-2"><span>Profesor asignado</span><span id="gestion-profesor-count" className="badge text-bg-light border">Selecciona un grupo</span></label>
<div className="profesor-picker profesor-picker-gestion">
<div className="input-group input-group-sm mb-2"><span className="input-group-text"><i className="bi bi-search"></i></span><input id="gestion-profesor-search" className="form-control" maxLength="120" placeholder="Buscar por nombre o materia..." autoComplete="off" disabled /></div>
<select id="gestion-grupo-profesor" className="form-select profesor-select" aria-label="Seleccionar profesor del grupo" disabled></select>
<div className="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-2 mt-2"><small id="gestion-profesor-hint" className="text-muted">Primero selecciona un grupo. Luego podrás consultar y modificar sus profesores.</small><button type="button" id="gestion-profesor-clear" className="btn btn-sm btn-link text-decoration-none px-0" disabled>Quitar selección</button></div>
</div></div></div></div><div className="modal-footer d-flex justify-content-between"><button type="button" id="btn-borrar-grupo" className="btn btn-outline-danger"><i className="bi bi-trash"></i> Borrar Grupo</button><div><button type="button" className="btn btn-outline-secondary me-2" data-bs-dismiss="modal">Cerrar</button><button type="submit" className="btn btn-primary">Guardar cambios</button></div></div></form>
      </Modal>
        ...
        <div className="modal-body p-4">
          <div className="row g-4">
            <div className="col-lg-7">
              <div className="section-form-card">
                <div className="mb-3">
                  ...
                  <p className="text-muted small mb-0">Completa el grado y la letra. El sistema la mostrará en formato <strong>1-A</strong>.</p>
                </div>
            ...
            <div className="col-lg-5">
              <div className="section-delete-card h-100">
                <h6 className="mb-1">Secciones registradas</h6>
